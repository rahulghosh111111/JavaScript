...
// console.log(name + roll + " Ka github");

// console.log(`Hello my name is ${name} & my github id is ${github}`);
...
// console.log(url.includes("rahul")); // return true or false

// console.log(url.includes("hello"));


// console.log(url.split("%20"));  // return array
